...
from repthon.core.decorators import check_owner
from repthon.helpers import humanbytes, progress
from repthon.helpers.utils import _reputils
...
# BACK
@zq_lo.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# UP
@zq_lo.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# DOWN
@zq_lo.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
# FORTH
@zq_lo.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# REMOVE
@zq_lo.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# SEND
@zq_lo.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# CUT
@zq_lo.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# COPY
@zq_lo.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@zq_lo.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
